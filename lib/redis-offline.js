/*!
 * redis-offline
 * (c) 2016 Todsaporn Banjerdkit <katopz@gmail.com>
 */
...
/**
 * RedisOffline constructor
 */
function RedisOffline() {
...
/**
 * RedisOffline inherits from EventEmitter to be mock pub/sub
 */
util.inherits(RedisOffline, events.EventEmitter);
...
/*
 * Create RedisOffline instance and export
 */
var MockInstance = new RedisOffline();
 ...
 */
RedisOffline.prototype.RedisClient = RedisClient;
...
RedisOffline.prototype.createClient = function (port_arg, host_arg, options) {
